...
export const Yahtzee = () => {
  ...
  return (
    <div className="flex flex-col h-screen bg-blue-200 pt-2 relative md:px-32 lg:px-96 md:pt-5">
      <h1 className="uppercase font-light text-center mb-3 md:mb-5">yahtzee</h1>
      <div className="grid grid-cols-2 gap-2 w-3/4 mx-auto mb-2">
        {upperLabels.map((label, i) => (
          <div className="flex" key={i}>
            ...
            <input
              type="number"
              className="p-1 w-1/2 mx-auto input"
      ...
      <div className="flex w-3/4 mx-auto mt-2 pt-2 border-t-2 border-gray-400">
        ...
        <p className="px-2 bg-gray-100 border-2 border-bg-400">
          {upperSubtotal}
        </p>
      </div>
        ...
        {lowerLabels.map((label, i) => (
          <div className="flex mb-1" key={i}>
            ...
            <input
              ...
              onChange={(e) => handleLowerInput(e, i)}
            />
          </div>
        ))}
      </div>
      <div className="flex mx-auto w-3/4 mb-1 mt-2 pt-2 border-t-2 border-gray-400">
        ...
        <p className="ml-2 px-2 bg-gray-100 border-2 border-bg-400">
          {lowerSubtotal}
        </p>
      </div>
      ...
      <button
        className="p-1 uppercase text-xs bg-gray-200 border-2 border-gray-400 absolute top-2 right-2 hover:bg-gray-100 md:top-5 md:right-5 lg:right-96"
        onClick={() => handleClear()}
      >
        clear
      </button>
